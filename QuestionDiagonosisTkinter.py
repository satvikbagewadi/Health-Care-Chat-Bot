...
training_dataset = pd.read_csv(r'D:\ML Internship\Health-Care-Chat-Bot-master\Training.csv')
test_dataset = pd.read_csv(r'D:\ML Internship\Health-Care-Chat-Bot-master\Testing.csv')
...
doc_dataset = pd.read_csv(r'D:\ML Internship\Health-Care-Chat-Bot-master\doctors_dataset.csv', names = ['Name', 'Description'])
...
class MainForm(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Health Care Chatbot", bg="#FFC300", width="300", height="2", font=("Calibri", 13))
        self.lblMsg.pack()
        ...
        self.lblTeam=Label(self, text="Made by:", bg="#BFE1FA", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="Satvik V Bagewadi", bg="#82BAE4", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="Pranali Kedar", bg="#62AAE0", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam2.pack()
        self.lblTeam3=Label(self, text="Addija Das", bg="#419BE0", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam3.pack()
        self.lblTeam3=Label(self, text="Shamanth TK", bg="#1C8BE0", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam3.pack()
...
class Login(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Please enter details below to login",bg="#FFC300")
        self.lblMsg.pack()
...
class SignUp(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Please enter details below", bg="#FFC300")
        self.lblMsg.pack()
        ...
        self.btnRegister=Button(self, text="Register", width=10, height=1, bg="white", command=self.register_user)
        self.btnRegister.pack()
